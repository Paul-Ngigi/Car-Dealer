...
public class App {
    public static void main(String[] args) {
        ...
        while (programRunning) {
            System.out.println(
                    "Welcome to our car dealership. What would you like to do? Enter one of the following options: All Vehicles or Search Price, Add Vehicle or Exit");

            String navigationChoice = console.readLine();

            if (navigationChoice.equals("All Vehicles".trim())) {
            ...
            } else if (navigationChoice.equals("Search Price".trim())) {
                ...
                System.out.println("Alright, here's what we have on your price tag.");
            ...
            } else if (navigationChoice.equals("Add Vehicle".trim())) {
                ...
                System.out.println("Great! What made or brand is the vehicle?");
                ...
                System.out.println("Alright here is your vehicle:");
                System.out.println("-----------------------------");
            ...
            } else if (navigationChoice.equals("Exit".trim())) {
